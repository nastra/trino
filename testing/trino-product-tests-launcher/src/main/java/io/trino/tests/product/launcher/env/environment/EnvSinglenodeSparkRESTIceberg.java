...
@TestsEnvironment
public class EnvSinglenodeSparkRESTIceberg
        extends EnvironmentProvider
{
    private static final int SPARK_THRIFT_PORT = 10213;
    private static final int REST_SERVER_PORT = 12345;
    private static final String SPARK = "spark";
    private static final String REST_CONTAINER_NAME = "iceberg_rest";
    private static final String REST_SERVER_IMAGE = "<TBD>";
    private static final String CONF_PATH = "conf/environment/singlenode-spark-iceberg-rest";
    ...
    @Inject
    public EnvSinglenodeSparkRESTIceberg(Standard standard, Hadoop hadoop, DockerFiles dockerFiles, EnvironmentConfig config, PortBinder portBinder)
    {
