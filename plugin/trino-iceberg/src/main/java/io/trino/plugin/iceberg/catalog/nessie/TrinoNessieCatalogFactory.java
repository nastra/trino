        ...
        implements TrinoCatalogFactory
{
            ...
            IcebergConfig icebergConfig)
    {
        ...
        this.warehouseLocation = nessieConfig.getWarehouseDir();
    ...
    {
        return new TrinoNessieCatalog(tableOperationsProvider, nessieApi,
                warehouseLocation, nessieConfig, isUniqueTableLocation);
    }
}
