        ...
        implements TrinoCatalogFactory
{
    ...
    {
        return new TrinoNessieCatalog(catalogName, hdfsEnvironment, typeManager, tableOperationsProvider, nessieClient, warehouseLocation, trinoVersion, isUniqueTableLocation);
    }
}
