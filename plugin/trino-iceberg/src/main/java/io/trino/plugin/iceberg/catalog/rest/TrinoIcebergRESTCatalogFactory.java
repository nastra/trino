        ...
        implements TrinoCatalogFactory
{
    ...
    private final RESTIcebergConfig restConfig;
        ...
        if (icebergCatalog == null) {
            synchronized (this) {
                if (icebergCatalog == null) {
                    ...
                    properties.put(CatalogProperties.URI, restConfig.getBaseUri());
                    ...
                    restConfig.getCredential().ifPresent(v -> properties.put(OAuth2Properties.CREDENTIAL, v));
                    restConfig.getToken().ifPresent(v -> properties.put(OAuth2Properties.TOKEN, v));
